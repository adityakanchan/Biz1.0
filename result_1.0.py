...
# Step 1: Load Data
existing_shops = pd.read_csv(r'E:\Bizlocation Project\experiment1\Existing_shops.csv')
landmarks = pd.read_csv(r'E:\Bizlocation Project\experiment1\Landmarks.csv')
available_shops = pd.read_csv(r'E:\Bizlocation Project\experiment1\Available_shops.csv')
...
#printing ranked list
print(sorted_available_shops_indices)
...
print("Top three potential locations for starting a new", interested_business, "business:")
for i, location in enumerate(top_three_locations, start=1):
    print("Location", i)
    print(location)
    print()
